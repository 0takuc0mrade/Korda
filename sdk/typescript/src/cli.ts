...
function getBackendUrl(flags: Record<string, string>): string {
  return (
    flags["backend"] ??
...
function createClient(flags: Record<string, string>): KordaClient {
  return new KordaClient({ baseUrl: getBackendUrl(flags) });
}

// ─── Commands ───────────────────────────────────────────────────────────────

async function cmdHealth(flags: Record<string, string>): Promise<void> {
